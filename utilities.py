...
class Utilities:
    ...
    def train_test_split(self, x, y, train_split=0.8, seed=0):
        ...
        self.train_ds = train_ds.shuffle(conf.buffer_size).batch(conf.batch_size).repeat()
        self.test_ds = test_ds.shuffle(conf.buffer_size).batch(conf.batch_size).repeat()
